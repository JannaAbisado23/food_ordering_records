...
<template>
    ...
    <div style="display: grid; place-content: center;">
        <form @submit.prevent="submit">
           <div class="mt-10 bg-slate-200 p-10 text-black text-center" style="font-size: 30px; width: 700px;">
            <b>Subject:</b> <br> <input class="text-black" v-model="form.subject" type="text" id="subject" style="width: 560px;"> <br>
            <b>Message:</b> <br> <textarea class="text-black" rows="5" cols="50" v-model="form.message" type="text" id="message"></textarea> <br>
            <button style="font-size: 20px;" type="submit" class="text-white px-4 py-1.5 rounded-md bg-orange-500">Send Message</button>
           </div>
        </form>
    </div>
